...
$isUserLoggedIn = isset($_SESSION['loginmhs']);
...
<body>
  <div class="sidebar">
    <div class="w3-sidebar w3-bar-block">
       <div class="logos">
        <a href="index.html" class="logo">
          <!-- <img src="assets/img/logos.jpg" alt="" width="80px" class=" my-3 ms-5"> -->
        <p> Perpustakaan Politeknik Negeri Padang</p>
        <!-- Menu-menu yang selalu tampil -->
        ...
        <a href="index.php?page=staff" class="w3-bar-item w3-button"><img src="assets/img/home.png"width=30px  alt="" class="me-2 mb-1">Staff List</a>

        <?php
        // Tampilkan menu tambahan jika pengguna adalah admin
        if ($isAdmin) {
            echo '<a href="index.php?page=visitor" class="w3-bar-item w3-button"><img src="assets/img/Bookshelf.png"width=30px  alt="" class="me-2 mb-1">Visitor</a>';
            echo '<a href="index.php?page=anggota" class="w3-bar-item w3-button"><img src="assets/img/home.png"width=30px  alt="" class="me-2 mb-1">Member</a>';
            echo '<a href="index.php?page=kategori" class="w3-bar-item w3-button"><img src="assets/img/home.png"width=30px  alt="" class="me-2 mb-1">Categories</a>';
            echo '<a href="index.php?page=pengarang" class="w3-bar-item w3-button"><img src="assets/img/home.png"width=30px  alt="" class="me-2 mb-1">Pengarang</a>';  
    ...
    echo '<a href="logoutmhs.php" class="ms-2">Logout</a>';
        }
        ?>
...
<div class="container" background-color: salmon;>
  <?php
        ...
        if ($p=='peminjaman') include 'peminjaman3.php';
      ...
      <div class="footer text-center fixed-bottom" style="margin-left:200px;">
        <p class="mt-1 text-white">Copyright 2023</p>
      </div>
</div>
  <!-- Vendor JS Files -->
  <script>
