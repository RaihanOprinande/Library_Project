    ...
    <div class="container-fluid">
        <div class="container mt-5 ">
         <?php if ($isUserLoggedIn && $isAdmin) : ?>
            <a href="" data-bs-toggle="modal" data-bs-target="#input-buku" class="btn btn-primary mb-4">Input Data</a>
            <?php endif; ?>
            ...
            <?php
                ...
                <tr>
                        ...
                        <td class="action-buttons">
                            ...
                            <a href="" data-bs-toggle="modal" data-bs-target="#editModal<?= $row['id'] ?>" class="btn btn-success">Edit</a>
