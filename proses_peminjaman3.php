            ...
            if ($resultLoans->num_rows > 0) {
                ...
                while ($rowLoan = $resultLoans->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td class="border-bottom-0">
                            <a class="btn btn-primary" href="proses_peminjaman3.php?proses=pengembalian&kode_buku={$rowLoan['kode_buku']}&peminjaman_id={$rowLoan['peminjaman_id']}">
                            <i class="ti ti-check"></i> Return
                            </a>
                            <a class="btn btn-danger" onclick="return confirm('Apakah yakin menghapusnya?')" href="proses_peminjaman3.php?proses=delete&kode_buku={$rowLoan['kode_buku']}&peminjaman_id={$rowLoan['peminjaman_id']}">
...
if (isset($_POST['peminjaman']) && isset($_POST['code']) && isset($_POST['id_member'])) {
    ...
    if ($currentLoanCount >= $maxLoanCount) {
        ...
        if ($resultGetIdBuku->num_rows > 0) {
            ...
            $type = $rowStatusKeanggotaan['status_keanggotaan']; // Gantilah dengan cara mendapatkan jenis pengguna yang sebenarnya
            if ($type == "Dosen") {
                  ...
                  <div class="table-responsive">
                      <table class="table text-nowrap mb-0 align-middle">
                          ...
                          <tbody>
                            ...
                            <!-- <td class="border-bottom-0">
                              <button name="submit" type="submit" class="btn btn-primary ti ti-check"></button>
                              <button name="submit" type="submit" class="btn btn-danger ti ti-x"></button>
                            </td> -->
