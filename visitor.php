...
?>
    <p class="text-center mt-4">Untuk input data silahkan <a href="?page=visitor&aksi=input" class="btn btn-primary">KLIK DI SINI</a></p>
...
<?php
    ...
    // Tambahkan ini di bagian paling atas sebelum HTML
    $query_jurusan = "SELECT * FROM jurusan";
    $result_jurusan = $db->query($query_jurusan);

    // // Function untuk mengambil data prodi berdasarkan id_jurusan
    // function getProdiByJurusan($jurusan_id, $db) {
    //     $query_prodi = "SELECT * FROM prodi WHERE jurusan_id = $jurusan_id";
