...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            ...
            <!-- Pada formulir pencarian -->
<form method="post" action="proses_peminjaman3.php" id="searchForm">
    <div class="row mb-2">
...
<form method="post" action="proses_peminjaman3.php" id="loanForm">
    <div class="row mb-2">
...
function searchLoans() {
    ...
    xhr.open('POST', 'proses_peminjaman3.php', true);
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState == 4 && xhr.status == 200) {
            ...
            // Displaying the 'btnLoansForm' button
