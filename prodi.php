...
<form action="proses_prodi.php?proses=insert" method="post">
    ...
    <div class="mb-3">
        ...
        <!-- Ambil data jurusan dari database untuk menampilkan opsi-opsi -->
        <select name="jurusan_id" class="form-select" required>
            ...
            // Loop untuk menampilkan opsi-opsi jurusan
...
<form action="proses_prodi.php?proses=update" method="post">
    ...
    <table class="table table-borderless">
        ...
        <tr>
            <td>Jurusan</td>
            <td>
                <!-- Tambahkan bagian formulir untuk jurusan sesuai dengan struktur yang sesuai -->
